...
export default class Auth extends Component {
    ...
    render (){
        ...
        validations.push(this.state.email && this.state.email.includes('@') && this.state.email.includes('.com'))
        ...
        return (
            <ImageBackground source={backgroundImage} 
                ...
                <View style={styles.formContainer}>
                    ...
                    <TouchableOpacity 
                        onPress={this.signinOrSignup} disable={!validForm}>
